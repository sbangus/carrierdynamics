...
class HadronElasticPhysicsHP : public G4HadronElasticPhysics
{
  ...
  private:
    ...
    // When this class is used in a custom physics list: thermal S(alpha,beta)
    // is ON by default. Toggle with /testhadr/phys/thermalScattering (PreInit).
    // The shipped executable uses Shielding_HPT_EMZ from the factory instead;
    // this messenger is then inactive.
