...
void RadioactiveDecayPhysics::ConstructProcess()
{
  ...
  // Atomic Rearrangement (fluorescence + Auger cascade) is ON for highest
  // precision: every (n,gamma), inelastic gamma, or radioactive-decay
  // vacancy is followed by the full atomic deexcitation cascade. Combined
  // with G4EmStandardPhysics_option4 this gives the most accurate
  // gamma+electron spectra from neutron-induced reactions.
  G4bool ARMflag = true;
